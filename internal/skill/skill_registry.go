...
var defaultSkillRegistry = &SkillRegistry{
...
func (r *SkillRegistry) Register(s *types.Skill) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *SkillRegistry) Get(name string) (*types.Skill, bool) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	s, ok := r.skills[name]
	return s, ok
...
func (r *SkillRegistry) List() []*types.Skill {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *SkillRegistry) Completions(prefix string) []string {
	r.mu.RLock()
	defer r.mu.RUnlock()
