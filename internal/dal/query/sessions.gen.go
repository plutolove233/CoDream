...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.Summary = field.NewString(tableName, "summary")
	_session.Status = field.NewString(tableName, "status")
	_session.Metadata = field.NewString(tableName, "metadata")
	_session.IsDeleted = field.NewBool(tableName, "is_deleted")
