...
func (f *FileHandler) Parameters() jsonschema.Definition {
	return jsonschema.Definition{
		Type: jsonschema.Object,
		Properties: map[string]jsonschema.Definition{
			"action": {
				Type:        jsonschema.String,
				Description: "The file operation to perform: 'read' or 'write'.",
			...
			"content": {
				Type:        jsonschema.String,
				Description: "The content to write to the file (required if action is 'write').",
			},
		},
